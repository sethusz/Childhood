...
?>
    ...
    ?>
                    ...
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        <h1 class="title underlined"><?php the_field('about_title'); ?></php></h1>
            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('number_phone_1') ?>"><?php the_field('number_phone_1') ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('number_phone_2') ?>"><?php the_field('number_phone_2') ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php echo do_shortcode('[contact-form-7 id="549005e" title="Форма отзывов"]'); ?>
</div>
                    </div>
                </div>
                <div class="row mt70">
